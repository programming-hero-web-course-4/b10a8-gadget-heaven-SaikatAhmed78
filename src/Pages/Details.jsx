...
const Details = () => {
    const [dasable, setDisable] = useState(false);
            ...
            <div className='flex gap-5 bg-white max-w-7xl mx-auto px-4 rounded-xl border relative p-6 -top-52'>
                ...
                <div className='space-y-2  px-6'>
                    ...
                    <div className='flex gap-3 items-center'>
                        ...
                        <button disabled = {dasable} onClick={() => handleAddToCartWishlist('wishlist', product)}>
                            <IoMdHeartEmpty  className={`${dasable === true && 'bg-gray-400 rounded-full w-10 h-10'}`} size={40} />
                        </button>
                    </div>
                </div>
            </div>
